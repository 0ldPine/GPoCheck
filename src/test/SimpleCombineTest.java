...
public class SimpleCombineTest {

	public final static String MODULEFILENAME = "files/easy1.gpo";

	public final static String PROPERITESFILENAME = "files/easy1.gpoctl";
	...
	public static void main(String[] args) throws Exception {
		SimpleCombineTest test = new SimpleCombineTest();
