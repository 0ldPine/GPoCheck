...
public class SimpleCombineTest2 {

	public final static String MODULEFILENAME = "files/thermostat_combine.gpo";

	public final static String PROPERITESFILENAME = "files/thermostat.gpoctl";
	...
	public static void main(String[] args) throws Exception {
		SimpleCombineTest2 test = new SimpleCombineTest2();
