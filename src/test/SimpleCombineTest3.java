...
public class SimpleCombineTest3 {

	public final static String MODULEFILENAME = "files/li1.gpo";

	public final static String PROPERITESFILENAME = "files/li1.poctl";
	...
	public static void main(String[] args) throws Exception {
		SimpleCombineTest3 test = new SimpleCombineTest3();
