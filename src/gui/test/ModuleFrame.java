...
public class ModuleFrame extends JFrame {
	...
	public ModuleFrame() {
		...
		SysManage.getContentPane().add(new JLabel("This is SysManage"), BorderLayout.CENTER);
		...
		getContentPane().add(new JLabel("This is MainFrame"), BorderLayout.CENTER);
		JButton ok = new JButton("OK");
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SysManage.pack();
				SysManage.setLocation(SysManage.getParent().getX() + (SysManage.getParent().getWidth() - SysManage.getWidth()) / 2, SysManage.getParent().getY() + (SysManage.getParent().getHeight() - SysManage.getHeight()) / 2);
