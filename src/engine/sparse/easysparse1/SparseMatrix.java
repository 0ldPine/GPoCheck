package engine.sparse.easysparse1;


/****************************************************************
 * This class provides functionality for storing, solving, and managing sparce
 * matrices. Only the non-zero entrys are stored. It represents the sparse
 * matrix as a two-dimensional linked list of the non-zero entrys. Each entry is
 * a Java primitive type int.
 ****************************************************************/
public class SparseMatrix  {
	...
	/*************************************************************
	 * Create an m-by-n SparseMatrix with storing it in the linked list.
	 * 
	 * @param m
	 ...
	 * @return a reference to a new SparseMatrix object that is equal to the sum
	 *         of this SparseMatrix and the passed one. If the passed
	 *         SparseMatrix is null or the number of rows and columns of this
	 *         SparseMatrix is not equal to the passed one, null will be
	 *         returned.
	 **************************************************************/
	...
	/*************************************************************
	 * Multiply the passed number to all entrys in this SparseMatrix.
	 * 
	 * @param k
	 *            the number to multiply this SparseMatrix by.
	 * @return a reference to a new Matrix object that is equal to the product
	 *         of this SpaseMatrix and the passed number.
	 **************************************************************/
	...
	/*************************************************************
	 * Return the maximum absolute row sum of this SparseMatrix.
	 * 
	...
	/*************************************************************
	 * Initialize this SparseMatrix with the values from the passed array.
	 * 
	 * @param a
	...
	/*************************************************************
	 * Display this SparseMatrix as a rectangular grid of values on the screen.
	 * It prints all the entrys in the matrix, including the implicit zeros.
	 **************************************************************/
