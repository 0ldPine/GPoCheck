...
import engine.sparse.csparsej.tfloat.Scs_entry;
...
import engine.sparse.csparsej.tfloat.Scs_print;
...
//        }
        String fileName = "files/sparsematrix1.txt";
        T = Scs_load.cs_load(args.length!=0?args[0]:fileName); /* load triplet matrix T from file */
        System.out.print("T:\n");
